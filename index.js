...
const teamHireHandler = require('./routeHandler/teamHireHandler');
const studentMonthlyPay = require('./routeHandler/studentMonthlyPay');
...
app.use('/temHire', teamHireHandler);
app.use('/studentMonthlyPay', studentMonthlyPay);
